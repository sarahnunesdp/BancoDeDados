...
SELECT * FROM VW_LISTA_CD
ORDER BY nomeCD, nomeMusica

--EX_04: 4.	Liste todas músicas compostas nos últimos 10 anos. 
--Classifique pela data de composição, de modo que a mais antiga apareça primeiro.
CREATE VIEW VW_LISTA_COMPOSICAO AS
SELECT
	Musica.nomeMusica,
	Compositor.nomeComp,
	Composicao.dataComp
...
SELECT*FROM VW_LISTA_COMPOSICAO
